...
import {Libro} from '../libro';//para importar libro
import{BibliotecaService} from '../biblioteca.service'// paraimporta el servicio
...
//le añado el servicio en el contr
    ...
    //luego en el servicio con los datos q le he paso
...
eviarFormulario(formulario:any)
{
  ...
  .subscribe(
    ...
    ()=>{     //3 funcion()=> fin vaci para decir lo q quieo q haba cuando termine
      console.log("fin");
    } 
  );
}
